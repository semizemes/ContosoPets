...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            {
                // Console.WriteLine(i);
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 2] == "Age: " || ourAnimals[i, 2] == "Age: ?"))
                {
                    do
                    {
                        Console.WriteLine();
                        ...
                        int checkNumber;
                        int.TryParse(updatedAge, out checkNumber);
                        if (updatedAge != null && updatedAge == "")
                        {
                            validEntry = int.TryParse(updatedAge, out checkNumber);
                        }
                        else if (int.TryParse(updatedAge, out checkNumber))
                        {
                ...
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 4] == "Physical description: " || ourAnimals[i, 4] == "Physical description: tbd"))
                {
                    do
                    {
                        ...
                        string? updatedPhysicalCondition = Console.ReadLine();
                        if (updatedPhysicalCondition != null && updatedPhysicalCondition == "")
                        {
                            validEntry = false;
                        }
                        else
                        {
                            ourAnimals[i, 4] = "Physical description: " + updatedPhysicalCondition;
                            validEntry = true;
                        }
                    } while (validEntry == false);
                }
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == "Nickname: tbd"))
                {
                    do
                    {
                        ...
                        string? updatedNickname = Console.ReadLine();
                        if (updatedNickname != null && updatedNickname == "")
                        {
                            validEntry = false;
                        }
                        else
                ...
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Personality: tbd"))
                {
                    do
                    {
                        ...
                        string? updatedPersonality = Console.ReadLine();
                        if (updatedPersonality != null && updatedPersonality == "")
                        {
                            validEntry = false;
                        }
                        else
                        {
                            ourAnimals[i, 5] = "Personality: " + updatedPersonality;
                            validEntry = true;
                        }
